...
git init
git add .
git commit -m "Feat: Arquitetura completa com HTML puro, SQLite e APIs NASA/Wikipedia"
git branch -M main
git remote add origin https://github.com/SEU_USUARIO/EspacoViagem-Visual.git
